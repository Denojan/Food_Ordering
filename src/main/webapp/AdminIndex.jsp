...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto" >
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="">Products</a></li>	
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<!-- Masthead-->
	<div class="masthead  text-white text-center" style="background-color:lightGray; background-size: 100%;">
		<div class="container d-flex align-items-center flex-column">
			<!-- Masthead Admin Image-->
			<img class="masthead-avatar mb-5" src="images\Admin.jpg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Admin Account</h1>
			<!-- Icon Divider-->
