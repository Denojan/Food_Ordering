				...
				<div class="update-content">
					...
					<br>
							<div class="form-group">
								<a href="viewAllAdmin.jsp" class="form-submit" style="text-decoration: none;"><input type="submit" name="delete" id="delete"
									class="form-submit bg-info" value="View All Admin" /></a><br><br>

							</div>
							<div class="form-group"><br><br>
								<a href="addAdmin.jsp" class="form-submit" style="text-decoration: none;"><input type="submit" name="delete" id="delete"
									class="form-submit bg-info" value="Add New Admin" /></a><br><br>
							</div>
							<div class="form-group"><br><br>
								<a href="AdminDetail.jsp" class="form-submit" style="text-decoration: none;"><input type="submit" name="delete" id="delete"
									class="form-submit bg-info" value="Admin Detail" /></a><br><br>
							</div>
							</td>
							</tr>
					</table>
