...
<a href="updateStaffForm.jsp" class="form-submit bg-info" style="text-decoration: none;"><input type="submit" name="edit" id="edit"
									class="form-submit bg-info" value="Edit Detail" /></a><br><br>
<a href="EditStaffPassword.jsp" class="form-submit bg-info" style="text-decoration: none;"><input type="submit" name="edit" id="edit"
