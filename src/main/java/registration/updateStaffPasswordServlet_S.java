...
/**
 * Denojan
 * Servlet implementation class updateStaffPasswordServlet
 */
@WebServlet("/updatestaffpassword_S")
public class updateStaffPasswordServlet_S extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(password == null || password.equals("")) {
			...
			dispatcher = request.getRequestDispatcher("EditStaffPassword_S.jsp");
	...
	if(newconfirm.equals(newpass)) {
		try{
			...
			PreparedStatement pst = con.prepareStatement("update staff set password = ?  where email =?");
